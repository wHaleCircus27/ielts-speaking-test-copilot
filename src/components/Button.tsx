...
const variants: Record<ButtonVariant, string> = {
  ...
  ghost:
    "border-transparent bg-transparent text-muted hover:bg-elevated hover:text-text",
  danger:
    "border-danger bg-transparent text-danger hover:bg-danger hover:text-white",
};
