...
| 2026-07-19 | RH-401~RH-406 工程与发布门禁 | in_progress | `d1fa8fc`、`122b89f`、`a585693` | 独立 worktree 离线 verify 通过；两类 audit 无 vulnerability 阻断；当前完整 Git 历史扫描通过；归档 `.app` 的 arm64、ad-hoc 签名、版本和许可资源正确 | 图标、Azure、`.app` smoke、branch protection、回滚与逐 RH 独立提交未满足 |
