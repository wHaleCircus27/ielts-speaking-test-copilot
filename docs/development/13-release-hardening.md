...
| 编号 | 优先级 | 任务 | 依赖 | 预估 | 状态 | 完成证据 |
| --- | --- | --- | --- | --- | --- | --- |
| RH-401 | P1 | 拆分 `pnpm verify` 与本地真实素材验收；用仓库内生成的小型 WAV fixture 保障 fresh clone 可运行 | RH-001 | 1 天 | in_progress | `d1fa8fc`；本地离线 verify 与确定性 fixture 通过，待独立 worktree 复验 |
...
| 2026-07-19 | RH-401~RH-406 工程与发布门禁 | in_progress | `d1fa8fc` | 两类 audit 无 vulnerability 阻断；15 个提交的 gitleaks 全历史扫描通过；arm64 `.app` 可构建且 ad-hoc 签名、版本和许可资源正确 | 图标、Azure、`.app` smoke、branch protection、回滚与逐 RH 独立提交未满足 |
